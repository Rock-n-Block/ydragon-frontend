...
//     <section className="section__about-us">
      ...
      <div className="video">
        ...
        <span className="video__info">
          ...
          <a className="video__info--link" href="/about_us">
            go here
          </a>
        </span>
      </div>
      <div className="features__wrapper">
        <div className="team__title-wrapper">
          <h1 className="team__title text-outline">TEAM</h1>
        </div>
          ...
          <div className="features__row">
            ...
            <div className="feature">
              ...
              <div className="feature__info">
                ...
                <span className="feature__info--text">
                  Sales and marketing expert for top IT companies for almost 8 years. Adept in
                  leading startup projects to success and developing their market all around the
                  world. Former Co-Founder and COO of an early stage blockchain project where he
                  managed a team.
                </span>
              </div>
            </div>
