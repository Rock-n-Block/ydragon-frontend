export default {
  ...
  StakingFactory: {
    ABI: [
        ...
        inputs: [
          {
            ...
            indexed: false,
            internalType: 'struct StakingFactory.Reward[]',
            name: 'rewards',
            type: 'tuple[]',
          },
          { indexed: false, internalType: 'uint256', name: 'currentTimestamp', type: 'uint256' },
        ],
        name: 'RewardAdded',
        type: 'event',
      },
      ...
      {
        inputs: [{ internalType: 'address', name: 'newMasterStaking', type: 'address' }],
        name: 'changeMasterStaking',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
      },
    ...
    ABI: [
      ...
      },
      {
        ...
        inputs: [
          ...
          { indexed: false, internalType: 'uint256', name: 'var1', type: 'uint256' },
          { indexed: false, internalType: 'uint256', name: 'var2', type: 'uint256' },
          { indexed: false, internalType: 'uint256', name: 'var3', type: 'uint256' },
          { indexed: false, internalType: 'uint256', name: 'var4', type: 'uint256' },
        ],
        name: 'Log',
        type: 'event',
      },
      ...
      {
        inputs: [{ internalType: 'contract IERC20', name: '_stakedToken', type: 'address' }],
        name: 'initialize',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
