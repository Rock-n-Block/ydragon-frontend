              ...
              values.tokens?.map((tokenDiff, index) => (
                <div className='rebalance-item' key={nextId()}>
                  <div className='rebalance-item__info'>
                    <img src={tokenDiff.token.image} alt='' width='36' height='36' className='rebalance-item__icon' />
                  ...
                  <div className='rebalance-item__input-wrapper'>
                    ...
                    {/* <AntdInput name={`tokens.${index}.current_weight`} defaultValue={tokenDiff.token.current_weight}
                             ...
                             onBlur={handleBlur}
                  /> */}
                  <Input name={`tokens[${index}].token.current_weight`} value={tokenDiff.token.current_weight}
                         onChange={handleChange}
                         onBlur={handleBlur} />
                  </div>
                  {/*
      ...
      <div className='rebalance-options-row'>
        ...
        <div className='rebalance-option'>
          ...
          <div className='rebalance-option__input-wrapper'>
            <Input name="days" value={values.days}
                   onChange={handleChange}
                   onBlur={handleBlur} />
          </div>
        </div>
        ...
        <div className='rebalance-option'>
          ...
          <div className='rebalance-option__input-wrapper'>
            <Input name="hours" value={values.hours}
                   onChange={handleChange}
                   onBlur={handleBlur} />
          </div>
        </div>
        ...
        <div className='rebalance-option'>
          ...
          <div className='rebalance-option__input-wrapper'>
            <Input name="steps" value={values.steps}
                   onChange={handleChange}
                   onBlur={handleBlur} />
          </div>
        </div>
